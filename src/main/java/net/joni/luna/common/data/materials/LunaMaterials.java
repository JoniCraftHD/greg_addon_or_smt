...
public class LunaMaterials {
    ...
    public static void register() {
        ...
        EightyFivePercentPureNevonianSteel = new Material.Builder(
                LunaCore.id("eightyfivepercentpurenevoniansteel")) // only one n
                .ingot()
        ...
        EightyFivePercentPureNevvonianSteel = new Material.Builder(
                LunaCore.id("eighty_five_percent_pure_nevvonian_steel"))
                .ingot()
                .element(LunaElements.APNS)
                .flags(LunaMaterialFlags.GENERATE_NANITES)
                .formula("APNS")
        ...
        PHOENIX_ENRICHED_TRITANIUM = new Material.Builder(
                LunaCore.id("phoenix_enriched_tritanium"))
                .ingot()
                .color(0xFF0000)
                .secondaryColor(0x840707)
                .flags(MaterialFlags.GENERATE_FRAME, LunaMaterialFlags.GENERATE_CRYSTAL_ROSE)
                .formula("PET")
                .iconSet(LunaMaterialSet.ALMOST_PURE_NEVONIAN_STEEL)
                .buildAndRegister();
        PHOENIX_ENRICHED_NAQUADAH = new Material.Builder(
                LunaCore.id("phoenix_enriched_naquadah"))
                .langValue("")
                .ingot()
                .color(0xFFA500)
        ...
        NIOBIUM_MODIFIED_SILICON_CARBIDE = new Material.Builder(
                LunaCore.id("niobium_modified_silicon_carbide"))
                .ingot()
                .color(0x4A4B6B)
        ...
        WAX_MELTING_CATALYST = new Material.Builder(
                LunaCore.id("wax_melting_catalyst"))
                .color(0xADD8E6)
                .fluid()
        ...
        CRYO_GRAPHITE_BINDING_SOLUTION = new Material.Builder(
                LunaCore.id("cryo_graphite_binding_solution"))
                .fluid()
                .color(0x507080)
