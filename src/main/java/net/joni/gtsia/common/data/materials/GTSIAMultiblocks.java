...
public class GTSIAMultiblocks {
    ...
    public static final MultiblockMachineDefinition RESONANCE_GEN = REGISTRATE
            ...
            .recipeType(GTSIARecipeTypes.RESONANCE_GEN)
            .recipeModifiers(GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT,
                    GTSIARecipeModifiers.RIFT_CHECK,
                    ...
                    .where("B",
                            Predicates
                                    .blocks(ForgeRegistries.BLOCKS
                                            .getValue(ResourceLocation.parse("luna:resonite_casing")))
            ...
            .workableCasingModel(GTCEu.id("block/casings/solid/machine_casing_clean_stainless_steel"),
                    (GTSIA.id("block/multiblock/resonance_gen")))
            .register();
