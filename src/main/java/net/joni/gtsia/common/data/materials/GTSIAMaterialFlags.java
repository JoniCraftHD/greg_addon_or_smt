...
public class GTSIAMaterialFlags {
    ...
    public static final TagPrefix nanites = new TagPrefix("nanites")
            ...
            .generateItem(true)
            .materialIconType(GTSIAMaterialSet.nanites)
            .generationCondition(mat -> mat.hasFlag(GTSIAMaterialFlags.GENERATE_NANITES));
    ...
    public static final TagPrefix crystal_rose = new TagPrefix("crystal_rose")
            ...
            .unificationEnabled(true)
            .generateItem(true)
            .materialIconType(GTSIAMaterialSet.crystal_rose)
            .generationCondition(mat -> mat.hasFlag(GTSIAMaterialFlags.GENERATE_CRYSTAL_ROSE));
    public static final TagPrefix File_Head = new TagPrefix("filehead")
            ...
            .materialAmount(GTValues.M * 4)
            .maxStackSize(16)
            .materialIconType(GTSIAMaterialSet.file_head)
            .unificationEnabled(true)
            .enableRecycling()
            .generateItem(true)
